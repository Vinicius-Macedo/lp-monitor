          ...
          <div className="w-full max-w-[540px]">
            ...
            <form className="flex flex-col gap-8">
              ...
              <p className="text-center text-white font-bold text-[12px]">
                ...
                investimentos contratada pelo BTG Pactual, na forma de
                legislação da CVM. Prezando por uma relação de transparência com
                seus clientes, ao informar seus dados nesta página você será
